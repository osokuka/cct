"""
Production settings for ARCOM Cleaning Management System.
"""
...
DEFAULT_FROM_EMAIL = config('EMAIL_HOST_USER', default='noreply@arcom.com')
...
ARCOM_SETTINGS = {
    ...
    'BARCODE_FORMAT': 'C{compound}-D-{building}-R{room}',
